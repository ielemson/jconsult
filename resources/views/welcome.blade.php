    ...
    <div id="preloader">
        <div id="loader" class="loader">
            <div class="loader-container">
                <div class="loader-icon"><img src="{{ asset("images/settings/$setting->website_logo_dark") }}" alt="Preloader"></div>
            </div>
        </div>
    </div>
    <!--Preloader-end -->
 ...
 @include('partials.navbar')
    ...
    <main class="fix">
     ...
     @include('partials.banner')
        ...
        <!-- about-area -->
        @include("partials.about-partials")
        <!-- about-area-end -->
        <!-- services-area -->
       @include("partials.services-partials")
        <!-- services-area-end -->
      
        <!-- project-area -->
        {{-- @include("partials.projects-partials") --}}
        <!-- project-area-end -->
        <!-- request-area -->
        ...
        <!-- blog-post-area -->
      @include("partials.blogs-partials")
        <!-- blog-post-area-end -->
        <!-- call-back-area -->
